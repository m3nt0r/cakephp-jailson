...
And a tree style delete which removes everything under the current object
...
@->free()@ is also called in @afterDelete@ so the database should clean itself up.
...
This is the first draft. I've written everything from scratch. Everything 
described in this document works for me on 1.3.3, but that doesn't imply that it 
also does for you. I kept the source clean and simple tho. Consider it beta. ;) 

Feel free to clone, fork and play around with it. Pull requests welcome!
