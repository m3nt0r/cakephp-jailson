...
Okay.. the examples are not really _real world_ but i wanted to show all possible ways to define access.

Lets go line by line:

* @'ninja'@ - The currently logged in user needs to be _lockedAs_ "ninja" to gain access.
